...
<!-- <body> -->
<!-- 	<h1> <small> List Courses: </small></h1> -->
<!-- 				<hr> -->
<!-- 				<br> -->
...
<%-- 								<td>${course.price }</td> --%>
<!-- 								<td> -->
<%-- 								<a href="/cart/addProduct?id=${course.id}" >Add To Cart</a> --%>
<!-- 								</td> -->
<!-- 							</tr> -->
<%-- 						</c:forEach> --%>
<!-- 					</tbody> -->
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="container-fluid page__container">
                                    <h2 class="bold m-4 text-center p-4">All Courses</h2>
                                    <div class="row">
...
<!-- 	                                                        <strong>4.7</strong><br /> -->
	                                                        ...
	                                                        <div class="dropdown" style="margin-left: 175px; margin-top;margin-top: -23px;">
		                                                        <a href="#" class="dropdown-toggle text-muted" data-caret="false" data-toggle="dropdown">
		                                                            <i class="material-icons">more_vert</i>
		                                                        </a>
		                                                        <div class="dropdown-menu dropdown-menu-right">
		                                                            <a class="dropdown-item" href="/course/detail?id=${course.id}">Course Details</a>
		                                                            <div class="dropdown-divider"></div>
	                                                                <a class="dropdown-item" href="/course/visitInstructor?id=${course.id}">Visit Instructor</a>
	                                                           	</div>
		                                                    </div>
	                                                    
	                                                        <small class="text-muted">(${course.placesNumber } places)</small>
	                                                    </div>
	                                                    
	                                                   
	                                                    
	                                                    <div class="d-flex align-items-center">
	                                                        <strong class="h5 m-0"><b>${course.price } MAD </b></strong>
