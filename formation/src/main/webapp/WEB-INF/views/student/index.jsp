...
<%-- <h2>welcome student  ${sessionScope.user } </h2> --%>
<%-- <security:authorize access="isAuthenticated()"> --%>
<%--     authenticated as <security:authentication property="principal.username" />  --%>
<%-- </security:authorize> --%>

<!-- <br> -->
<!-- <a href="/editStudent">Edit Account</a>	<br> -->
<!-- <a href="course/takeCourse">Take Course</a>	 -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h4 class="text-muted mb-2">Courses Taken</h4>
                                                    <h4 class="m-0 bold">${nbrEnrollement }</h4>
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h4 class="text-muted mb-2">Last Session Opened</h4>
                                                    <h4 class="m-0 bold"> ${date } </h4>
                                                </div>
                                ...
                                <div class="container-fluid page__container">
									...
									<c:forEach items="${recentCoures }" var="course">
                                        <div class="col-md-3">
