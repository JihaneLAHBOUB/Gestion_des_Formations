...
<%-- 								<td>${item.course.createdOn }</td> --%>
<%-- 								<td>${item.course.description }</td> --%>
<%-- 								<td>${item.course.placesNumber }</td> --%>
<%-- 								<td>${isConfirm }</td> --%>
<%-- 								<td>${item.course.price }</td> --%>
<!-- 								<td> -->
<%-- 								<a href="/enroll/confirm?id=${item.course.id}" >Confirm Enroll</a> --%>
<!-- 								</td> -->
<!-- 							</tr> -->
<%-- 						</c:forEach> --%>
<%-- 						<c:forEach items="${enrolledCoures }" var="course"> --%>
<!-- 							<tr> -->
<%-- 								<td>${course.id }</td> --%>
<%-- 								<td>${course.name }</td> --%>
...
<%-- 								<td>${course.price }</td> --%>
<!-- 								<td> -->
<%-- 								<a href="/enroll/confirm?id=${course.id}" >Confirm Enroll</a> --%>
<!-- 								</td> -->
<!-- 							</tr> -->
<%-- 						</c:forEach> --%>
<!-- 					</tbody> -->
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card card__course card__course__animate">
                                    <div class="p-3 text-center border-bottom">
										...
										<div class="d-flex justify-content-around">
											<a href="/rate/add?id=${course.id }" class="btn btn__bg d-block" style="width: 200px; color:black; background-color:#f0ca4d">Rate Course</a>
										</div>
                                    </div>
                                </div>
                            </div>
