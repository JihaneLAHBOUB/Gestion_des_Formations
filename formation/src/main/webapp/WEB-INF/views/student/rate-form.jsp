...
input.e_star:checked ~ label.e_star:before {
  content:'\f005';
  color: #FD4;
  transition: all .25s;
}
input.e_star-5:checked ~ label.e_star:before {
  color:#FE7;
  text-shadow: 0 0 20px #952;
}

input.e_star-1:checked ~ label.e_star:before {
  color: #F62;
}
label.e_star:hover{
...
input.i_star:checked ~ label.i_star:before {
  content:'\f005';
  color: #FD4;
  transition: all .25s;
}
input.i_star-5:checked ~ label.i_star:before {
  color:#FE7;
  text-shadow: 0 0 20px #952;
}

input.i_star-1:checked ~ label.i_star:before {
  color: #F62;
}
label.i_star:hover{
  transform: rotate(-15deg) scale(1.3);
...
input.c_star:checked ~ label.c_star:before {
  content:'\f005';
  color: #FD4;
  transition: all .25s;
}
input.c_star-5:checked ~ label.c_star:before {
  color:#FE7;
  text-shadow: 0 0 20px #952;
}

input.c_star-1:checked ~ label.c_star:before {
  color: #F62;
}
label.c_star:hover{
  transform: rotate(-15deg) scale(1.3);
                ...
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="card">
                                <form action="/rate/saveRate?id=${course.id }" method="post">
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="card">
                                            <div class="card-form__body card-body">
                                                ...
                                                <div class="stars">
                                                    <input class="e_star e_star-1" type="radio" name="establishmentRate" value="5" id="e1"><label class="e_star e_star-1" for="e1"></label>
                                                    <input class="e_star e_star-2" type="radio" name="establishmentRate" value="4" id="e2"><label class="e_star e_star-2" for="e2"></label>
                                                    <input class="e_star e_star-3" type="radio" name="establishmentRate" value="3" id="e3"><label class="e_star e_star-3" for="e3"></label>
                                                    <input class="e_star e_star-4" type="radio" name="establishmentRate" value="2" id="e4"><label class="e_star e_star-4" for="e4"></label>
                                                    <input class="e_star e_star-5" type="radio" name="establishmentRate" value="1" id="e5"><label class="e_star e_star-5" for="e5"></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card">
                                            <div class="card-form__body card-body">
                                                ...
                                                <div class="stars">
                                                    <input class="i_star i_star-1" type="radio" name="instructorRate" value="5" id="i1"><label class="i_star i_star-1" for="i1"></label>
                                                    <input class="i_star i_star-2" type="radio" name="instructorRate" value="4" id="i2"><label class="i_star i_star-2" for="i2"></label>
                                                    <input class="i_star i_star-3" type="radio" name="instructorRate" value="3" id="i3"><label class="i_star i_star-3" for="i3"></label>
                                                    <input class="i_star i_star-4" type="radio" name="instructorRate" value="2" id="i4"><label class="i_star i_star-4" for="i4"></label>
                                                    <input class="i_star i_star-5" type="radio" name="instructorRate" value="1" id="i5"><label class="i_star i_star-5" for="i5"></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card">
                                            <div class="card-form__body card-body">
                                                ...
                                                <div class="stars">
                                                    <input class="c_star c_star-1" type="radio" name="contentRate" value="5" id="c1"><label class="c_star c_star-1" for="c1"></label>
                                                    <input class="c_star c_star-2" type="radio" name="contentRate" value="4" id="c2"><label class="c_star c_star-2" for="c2"></label>
                                                    <input class="c_star c_star-3" type="radio" name="contentRate" value="3" id="c3"><label class="c_star c_star-3" for="c3"></label>
                                                    <input class="c_star c_star-4" type="radio" name="contentRate" value="2" id="c4"><label class="c_star c_star-4" for="c4"></label>
                                                    <input class="c_star c_star-5" type="radio" name="contentRate" value="1" id="c5"><label class="c_star c_star-5" for="c5"></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body text-center">
                                        <button type="submit" class="btn btn-success" data-toggle="modal" data-target="#modal-info">Save Rates</button>
                                    </div>
									</form>
                                </div>
                            </div>
                                ...
                                <ul class="sidebar-menu mt-0">
                                    ...
                                    <li class="sidebar-menu-item">
                                        <a class="sidebar-menu-button" href="/enroll/enrolledCourses">
                                            ...
                                            <span class="sidebar-menu-text">MyCourses</span>
                                        </a>
                                    </li>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    <h4 style="font-weight: bold;">Thanks <i class="material-icons" style="color: red;">favorite</i></h4>
                    <p class="mt-3" style="font-weight: bold;">${rate }</p>
                    <div>
                        <span class="mr-2">
                            <a href="#" class="rating-link active"><i class="material-icons icon-16pt" style="color:yellow;">star</i></a>
                            <a href="#" class="rating-link active"><i class="material-icons icon-16pt" style="color:yellow;">star</i></a>
                            <a href="#" class="rating-link active"><i class="material-icons icon-16pt" style="color:yellow;">star</i></a>
                            <a href="#" class="rating-link active"><i class="material-icons icon-16pt" style="color:yellow;">star</i></a>
                            <a href="#" class="rating-link active"><i class="material-icons icon-16pt" style="color:yellow;">star</i></a>
