                            ...
                            <div class="col-md-8">
                                <div class="card">
                    				...
                    				<div class="card-body text-center">
                                        ...
                                        <a href="/course/takeCourse"><i class="fa fa-arrow-left"></i> Back to Course List</a>
                                    </div>
                                </div>
                            </div>
...
<!--                             </div> -->
<!--                            <div class="form-group"> Number of enrollement: -->
<%--                             	<p> ${nbr } </p> --%>
<!--                             </div> -->
<!--                             <div class="form-group"> List of Sections -->
<%-- 	                            <c:forEach items="${listSection }" var="section"> --%>
<%-- 									<p> ${section.chapter } </p> --%>
